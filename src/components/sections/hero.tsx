      ...
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute inset-0">
          <svg className="absolute h-full w-full" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <pattern id="grid" width="5532" height="32" patternUnits="userSpaceOnUse">
        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          >
            ...
            <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-blue-100 text-blue-800 mb-6">
              <PuzzlePieceIcon className="w-4 h-4 mr-1 text-yellow-400" />
              你好呀 
            </span>
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600 max-w-2xl mx-auto">
              一个勇敢、自由、快乐的创造者，很高兴认识你，美好世界的一部分
            </p>
          </motion.div>
          ...
          >
            <div className="relative">
              ...
              <div className="absolute -inset-x-2 -top-16 -bottom-16 flex justify-center">
                <div className="w-[500px] h-[600px] bg-gradient-to-r from-blue-400/20 via-cyan-400/20 to-purple-400/20 blur-3xl" />
              </div>
              ...
              <div className="relative rounded-xl overflow-hidden shadow-2xl ring-1 ring-gray-900/5">
                ...
                <img src="微信图片_20241125232541.jpg" alt="MIKO" className="aspect-[9/16] w-full max-w-xs mx-auto bg-gray-100 rounded-xl shadow-inner" />
          ...
          >
            <div className="flex gap-x-4 items-center text-sm text-gray-500">
              <span className="font-medium">已在地球旅行天数</span>
              <span className="h-4 w-px bg-gray-300" />
              <span className="font-semibold text-gray-900">6000+</span>
            </div>
            <div className="flex gap-x-4 items-center text-sm text-gray-500">
              <span className="font-medium">其他旅行者评分</span>
              <span className="h-4 w-px bg-gray-300" />
              <span className="font-semibold text-gray-900">5.1 / 5.0</span>
            </div>
          </motion.div>
        </div>
      </div>
